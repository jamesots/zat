// This file was generated by GenerateOpcodes.ts. Do not modify.

import {Z80} from "./Z80.js";
import {toHex, inc8, inc16, dec8, dec16, add8, add16, sub8, sub16, word, hi, lo, Flag, signedByte} from "../z80-base/index.js";
...
decodeMapDD.set(0xCB, (z80: Z80) => { // shift cb
    decodeDDCB(z80);
});
...
decodeMapDDCB.set(0x46, (z80: Z80) => { // bit 0,(ix+dd)
...
decodeMapDDCB.set(0x4E, (z80: Z80) => { // bit 1,(ix+dd)
    const value = z80.readByte(z80.regs.memptr);
    const hiddenValue = hi(z80.regs.memptr);
    z80.incTStateCount(1);
    let f = (z80.regs.f & Flag.C) | Flag.H | (hiddenValue & (Flag.X3 | Flag.X5));
...
decodeMapDDCB.set(0x56, (z80: Z80) => { // bit 2,(ix+dd)
    const value = z80.readByte(z80.regs.memptr);
    const hiddenValue = hi(z80.regs.memptr);
    z80.incTStateCount(1);
    let f = (z80.regs.f & Flag.C) | Flag.H | (hiddenValue & (Flag.X3 | Flag.X5));
...
decodeMapDDCB.set(0x5E, (z80: Z80) => { // bit 3,(ix+dd)
    const value = z80.readByte(z80.regs.memptr);
    const hiddenValue = hi(z80.regs.memptr);
    z80.incTStateCount(1);
    let f = (z80.regs.f & Flag.C) | Flag.H | (hiddenValue & (Flag.X3 | Flag.X5));
...
decodeMapDDCB.set(0x66, (z80: Z80) => { // bit 4,(ix+dd)
    const value = z80.readByte(z80.regs.memptr);
    const hiddenValue = hi(z80.regs.memptr);
    z80.incTStateCount(1);
    let f = (z80.regs.f & Flag.C) | Flag.H | (hiddenValue & (Flag.X3 | Flag.X5));
...
decodeMapDDCB.set(0x6E, (z80: Z80) => { // bit 5,(ix+dd)
    const value = z80.readByte(z80.regs.memptr);
    const hiddenValue = hi(z80.regs.memptr);
    z80.incTStateCount(1);
    let f = (z80.regs.f & Flag.C) | Flag.H | (hiddenValue & (Flag.X3 | Flag.X5));
...
decodeMapDDCB.set(0x76, (z80: Z80) => { // bit 6,(ix+dd)
    const value = z80.readByte(z80.regs.memptr);
    const hiddenValue = hi(z80.regs.memptr);
    z80.incTStateCount(1);
    let f = (z80.regs.f & Flag.C) | Flag.H | (hiddenValue & (Flag.X3 | Flag.X5));
...
decodeMapDDCB.set(0x7E, (z80: Z80) => { // bit 7,(ix+dd)
    const value = z80.readByte(z80.regs.memptr);
    const hiddenValue = hi(z80.regs.memptr);
    z80.incTStateCount(1);
    let f = (z80.regs.f & Flag.C) | Flag.H | (hiddenValue & (Flag.X3 | Flag.X5));
...
decodeMapED.set(0x44, (z80: Z80) => { // neg 
    const value = z80.regs.a;
    z80.regs.a = 0;
...
decodeMapED.set(0x45, (z80: Z80) => { // retn 
    z80.regs.iff1 = z80.regs.iff2;
    z80.regs.pc = z80.popWord();
    z80.regs.memptr = z80.regs.pc;
});
decodeMapED.set(0x46, (z80: Z80) => { // im 0
    z80.regs.im = 0;
});
...
decodeMapED.set(0x56, (z80: Z80) => { // im 1
    z80.regs.im = 1;
});
...
decodeMapED.set(0x5E, (z80: Z80) => { // im 2
    z80.regs.im = 2;
});
...
decodeMapFD.set(0xCB, (z80: Z80) => { // shift cb
    decodeFDCB(z80);
});
...
decodeMapFDCB.set(0x46, (z80: Z80) => { // bit 0,(iy+dd)
    const value = z80.readByte(z80.regs.memptr);
    const hiddenValue = hi(z80.regs.memptr);
    z80.incTStateCount(1);
    let f = (z80.regs.f & Flag.C) | Flag.H | (hiddenValue & (Flag.X3 | Flag.X5));
...
decodeMapFDCB.set(0x4E, (z80: Z80) => { // bit 1,(iy+dd)
    const value = z80.readByte(z80.regs.memptr);
    const hiddenValue = hi(z80.regs.memptr);
    z80.incTStateCount(1);
    let f = (z80.regs.f & Flag.C) | Flag.H | (hiddenValue & (Flag.X3 | Flag.X5));
...
decodeMapFDCB.set(0x56, (z80: Z80) => { // bit 2,(iy+dd)
    const value = z80.readByte(z80.regs.memptr);
    const hiddenValue = hi(z80.regs.memptr);
    z80.incTStateCount(1);
    let f = (z80.regs.f & Flag.C) | Flag.H | (hiddenValue & (Flag.X3 | Flag.X5));
...
decodeMapFDCB.set(0x5E, (z80: Z80) => { // bit 3,(iy+dd)
    const value = z80.readByte(z80.regs.memptr);
    const hiddenValue = hi(z80.regs.memptr);
    z80.incTStateCount(1);
    let f = (z80.regs.f & Flag.C) | Flag.H | (hiddenValue & (Flag.X3 | Flag.X5));
...
decodeMapFDCB.set(0x66, (z80: Z80) => { // bit 4,(iy+dd)
    const value = z80.readByte(z80.regs.memptr);
    const hiddenValue = hi(z80.regs.memptr);
    z80.incTStateCount(1);
    let f = (z80.regs.f & Flag.C) | Flag.H | (hiddenValue & (Flag.X3 | Flag.X5));
...
decodeMapFDCB.set(0x6E, (z80: Z80) => { // bit 5,(iy+dd)
    const value = z80.readByte(z80.regs.memptr);
    const hiddenValue = hi(z80.regs.memptr);
    z80.incTStateCount(1);
    let f = (z80.regs.f & Flag.C) | Flag.H | (hiddenValue & (Flag.X3 | Flag.X5));
...
decodeMapFDCB.set(0x76, (z80: Z80) => { // bit 6,(iy+dd)
    const value = z80.readByte(z80.regs.memptr);
    const hiddenValue = hi(z80.regs.memptr);
    z80.incTStateCount(1);
    let f = (z80.regs.f & Flag.C) | Flag.H | (hiddenValue & (Flag.X3 | Flag.X5));
...
decodeMapFDCB.set(0x7E, (z80: Z80) => { // bit 7,(iy+dd)
    const value = z80.readByte(z80.regs.memptr);
    const hiddenValue = hi(z80.regs.memptr);
    z80.incTStateCount(1);
    let f = (z80.regs.f & Flag.C) | Flag.H | (hiddenValue & (Flag.X3 | Flag.X5));
...
decodeMapDD.set(0x43, decodeMapBASE.get(0x43) as OpcodeFunc);
decodeMapDD.set(0x47, decodeMapBASE.get(0x47) as OpcodeFunc);
decodeMapDD.set(0x48, decodeMapBASE.get(0x48) as OpcodeFunc);
decodeMapDD.set(0x49, decodeMapBASE.get(0x49) as OpcodeFunc);
decodeMapDD.set(0x4A, decodeMapBASE.get(0x4A) as OpcodeFunc);
decodeMapDD.set(0x4B, decodeMapBASE.get(0x4B) as OpcodeFunc);
decodeMapDD.set(0x4F, decodeMapBASE.get(0x4F) as OpcodeFunc);
decodeMapDD.set(0x50, decodeMapBASE.get(0x50) as OpcodeFunc);
decodeMapDD.set(0x51, decodeMapBASE.get(0x51) as OpcodeFunc);
decodeMapDD.set(0x52, decodeMapBASE.get(0x52) as OpcodeFunc);
decodeMapDD.set(0x53, decodeMapBASE.get(0x53) as OpcodeFunc);
decodeMapDD.set(0x57, decodeMapBASE.get(0x57) as OpcodeFunc);
decodeMapDD.set(0x58, decodeMapBASE.get(0x58) as OpcodeFunc);
decodeMapDD.set(0x59, decodeMapBASE.get(0x59) as OpcodeFunc);
decodeMapDD.set(0x5A, decodeMapBASE.get(0x5A) as OpcodeFunc);
decodeMapDD.set(0x5B, decodeMapBASE.get(0x5B) as OpcodeFunc);
decodeMapDD.set(0x5F, decodeMapBASE.get(0x5F) as OpcodeFunc);
decodeMapDD.set(0x78, decodeMapBASE.get(0x78) as OpcodeFunc);
decodeMapDD.set(0x79, decodeMapBASE.get(0x79) as OpcodeFunc);
...
decodeMapDDCB.set(0x43, decodeMapDDCB.get(0x46) as OpcodeFunc);
decodeMapDDCB.set(0x44, decodeMapDDCB.get(0x46) as OpcodeFunc);
decodeMapDDCB.set(0x45, decodeMapDDCB.get(0x46) as OpcodeFunc);
decodeMapDDCB.set(0x47, decodeMapDDCB.get(0x46) as OpcodeFunc);
decodeMapDDCB.set(0x48, decodeMapDDCB.get(0x4E) as OpcodeFunc);
decodeMapDDCB.set(0x49, decodeMapDDCB.get(0x4E) as OpcodeFunc);
decodeMapDDCB.set(0x4A, decodeMapDDCB.get(0x4E) as OpcodeFunc);
decodeMapDDCB.set(0x4B, decodeMapDDCB.get(0x4E) as OpcodeFunc);
decodeMapDDCB.set(0x4C, decodeMapDDCB.get(0x4E) as OpcodeFunc);
decodeMapDDCB.set(0x4D, decodeMapDDCB.get(0x4E) as OpcodeFunc);
decodeMapDDCB.set(0x4F, decodeMapDDCB.get(0x4E) as OpcodeFunc);
decodeMapDDCB.set(0x50, decodeMapDDCB.get(0x56) as OpcodeFunc);
decodeMapDDCB.set(0x51, decodeMapDDCB.get(0x56) as OpcodeFunc);
decodeMapDDCB.set(0x52, decodeMapDDCB.get(0x56) as OpcodeFunc);
decodeMapDDCB.set(0x53, decodeMapDDCB.get(0x56) as OpcodeFunc);
decodeMapDDCB.set(0x54, decodeMapDDCB.get(0x56) as OpcodeFunc);
decodeMapDDCB.set(0x55, decodeMapDDCB.get(0x56) as OpcodeFunc);
decodeMapDDCB.set(0x57, decodeMapDDCB.get(0x56) as OpcodeFunc);
decodeMapDDCB.set(0x58, decodeMapDDCB.get(0x5E) as OpcodeFunc);
decodeMapDDCB.set(0x59, decodeMapDDCB.get(0x5E) as OpcodeFunc);
decodeMapDDCB.set(0x5A, decodeMapDDCB.get(0x5E) as OpcodeFunc);
decodeMapDDCB.set(0x5B, decodeMapDDCB.get(0x5E) as OpcodeFunc);
decodeMapDDCB.set(0x5C, decodeMapDDCB.get(0x5E) as OpcodeFunc);
decodeMapDDCB.set(0x5D, decodeMapDDCB.get(0x5E) as OpcodeFunc);
decodeMapDDCB.set(0x5F, decodeMapDDCB.get(0x5E) as OpcodeFunc);
decodeMapDDCB.set(0x60, decodeMapDDCB.get(0x66) as OpcodeFunc);
decodeMapDDCB.set(0x61, decodeMapDDCB.get(0x66) as OpcodeFunc);
decodeMapDDCB.set(0x62, decodeMapDDCB.get(0x66) as OpcodeFunc);
decodeMapDDCB.set(0x63, decodeMapDDCB.get(0x66) as OpcodeFunc);
decodeMapDDCB.set(0x64, decodeMapDDCB.get(0x66) as OpcodeFunc);
decodeMapDDCB.set(0x65, decodeMapDDCB.get(0x66) as OpcodeFunc);
decodeMapDDCB.set(0x67, decodeMapDDCB.get(0x66) as OpcodeFunc);
decodeMapDDCB.set(0x68, decodeMapDDCB.get(0x6E) as OpcodeFunc);
decodeMapDDCB.set(0x69, decodeMapDDCB.get(0x6E) as OpcodeFunc);
decodeMapDDCB.set(0x6A, decodeMapDDCB.get(0x6E) as OpcodeFunc);
decodeMapDDCB.set(0x6B, decodeMapDDCB.get(0x6E) as OpcodeFunc);
decodeMapDDCB.set(0x6C, decodeMapDDCB.get(0x6E) as OpcodeFunc);
decodeMapDDCB.set(0x6D, decodeMapDDCB.get(0x6E) as OpcodeFunc);
decodeMapDDCB.set(0x6F, decodeMapDDCB.get(0x6E) as OpcodeFunc);
decodeMapDDCB.set(0x70, decodeMapDDCB.get(0x76) as OpcodeFunc);
decodeMapDDCB.set(0x71, decodeMapDDCB.get(0x76) as OpcodeFunc);
decodeMapDDCB.set(0x72, decodeMapDDCB.get(0x76) as OpcodeFunc);
decodeMapDDCB.set(0x73, decodeMapDDCB.get(0x76) as OpcodeFunc);
decodeMapDDCB.set(0x74, decodeMapDDCB.get(0x76) as OpcodeFunc);
decodeMapDDCB.set(0x75, decodeMapDDCB.get(0x76) as OpcodeFunc);
decodeMapDDCB.set(0x77, decodeMapDDCB.get(0x76) as OpcodeFunc);
decodeMapDDCB.set(0x78, decodeMapDDCB.get(0x7E) as OpcodeFunc);
decodeMapDDCB.set(0x79, decodeMapDDCB.get(0x7E) as OpcodeFunc);
decodeMapDDCB.set(0x7A, decodeMapDDCB.get(0x7E) as OpcodeFunc);
decodeMapDDCB.set(0x7B, decodeMapDDCB.get(0x7E) as OpcodeFunc);
...
decodeMapFD.set(0x43, decodeMapBASE.get(0x43) as OpcodeFunc);
decodeMapFD.set(0x47, decodeMapBASE.get(0x47) as OpcodeFunc);
decodeMapFD.set(0x48, decodeMapBASE.get(0x48) as OpcodeFunc);
decodeMapFD.set(0x49, decodeMapBASE.get(0x49) as OpcodeFunc);
decodeMapFD.set(0x4A, decodeMapBASE.get(0x4A) as OpcodeFunc);
decodeMapFD.set(0x4B, decodeMapBASE.get(0x4B) as OpcodeFunc);
decodeMapFD.set(0x4F, decodeMapBASE.get(0x4F) as OpcodeFunc);
decodeMapFD.set(0x50, decodeMapBASE.get(0x50) as OpcodeFunc);
decodeMapFD.set(0x51, decodeMapBASE.get(0x51) as OpcodeFunc);
decodeMapFD.set(0x52, decodeMapBASE.get(0x52) as OpcodeFunc);
decodeMapFD.set(0x53, decodeMapBASE.get(0x53) as OpcodeFunc);
decodeMapFD.set(0x57, decodeMapBASE.get(0x57) as OpcodeFunc);
decodeMapFD.set(0x58, decodeMapBASE.get(0x58) as OpcodeFunc);
decodeMapFD.set(0x59, decodeMapBASE.get(0x59) as OpcodeFunc);
decodeMapFD.set(0x5A, decodeMapBASE.get(0x5A) as OpcodeFunc);
decodeMapFD.set(0x5B, decodeMapBASE.get(0x5B) as OpcodeFunc);
decodeMapFD.set(0x5F, decodeMapBASE.get(0x5F) as OpcodeFunc);
decodeMapFD.set(0x78, decodeMapBASE.get(0x78) as OpcodeFunc);
decodeMapFD.set(0x79, decodeMapBASE.get(0x79) as OpcodeFunc);
...
decodeMapFDCB.set(0x43, decodeMapFDCB.get(0x46) as OpcodeFunc);
decodeMapFDCB.set(0x44, decodeMapFDCB.get(0x46) as OpcodeFunc);
decodeMapFDCB.set(0x45, decodeMapFDCB.get(0x46) as OpcodeFunc);
decodeMapFDCB.set(0x47, decodeMapFDCB.get(0x46) as OpcodeFunc);
decodeMapFDCB.set(0x48, decodeMapFDCB.get(0x4E) as OpcodeFunc);
decodeMapFDCB.set(0x49, decodeMapFDCB.get(0x4E) as OpcodeFunc);
decodeMapFDCB.set(0x4A, decodeMapFDCB.get(0x4E) as OpcodeFunc);
decodeMapFDCB.set(0x4B, decodeMapFDCB.get(0x4E) as OpcodeFunc);
decodeMapFDCB.set(0x4C, decodeMapFDCB.get(0x4E) as OpcodeFunc);
decodeMapFDCB.set(0x4D, decodeMapFDCB.get(0x4E) as OpcodeFunc);
decodeMapFDCB.set(0x4F, decodeMapFDCB.get(0x4E) as OpcodeFunc);
decodeMapFDCB.set(0x50, decodeMapFDCB.get(0x56) as OpcodeFunc);
decodeMapFDCB.set(0x51, decodeMapFDCB.get(0x56) as OpcodeFunc);
decodeMapFDCB.set(0x52, decodeMapFDCB.get(0x56) as OpcodeFunc);
decodeMapFDCB.set(0x53, decodeMapFDCB.get(0x56) as OpcodeFunc);
decodeMapFDCB.set(0x54, decodeMapFDCB.get(0x56) as OpcodeFunc);
decodeMapFDCB.set(0x55, decodeMapFDCB.get(0x56) as OpcodeFunc);
decodeMapFDCB.set(0x57, decodeMapFDCB.get(0x56) as OpcodeFunc);
decodeMapFDCB.set(0x58, decodeMapFDCB.get(0x5E) as OpcodeFunc);
decodeMapFDCB.set(0x59, decodeMapFDCB.get(0x5E) as OpcodeFunc);
decodeMapFDCB.set(0x5A, decodeMapFDCB.get(0x5E) as OpcodeFunc);
decodeMapFDCB.set(0x5B, decodeMapFDCB.get(0x5E) as OpcodeFunc);
decodeMapFDCB.set(0x5C, decodeMapFDCB.get(0x5E) as OpcodeFunc);
decodeMapFDCB.set(0x5D, decodeMapFDCB.get(0x5E) as OpcodeFunc);
decodeMapFDCB.set(0x5F, decodeMapFDCB.get(0x5E) as OpcodeFunc);
decodeMapFDCB.set(0x60, decodeMapFDCB.get(0x66) as OpcodeFunc);
decodeMapFDCB.set(0x61, decodeMapFDCB.get(0x66) as OpcodeFunc);
decodeMapFDCB.set(0x62, decodeMapFDCB.get(0x66) as OpcodeFunc);
decodeMapFDCB.set(0x63, decodeMapFDCB.get(0x66) as OpcodeFunc);
decodeMapFDCB.set(0x64, decodeMapFDCB.get(0x66) as OpcodeFunc);
decodeMapFDCB.set(0x65, decodeMapFDCB.get(0x66) as OpcodeFunc);
decodeMapFDCB.set(0x67, decodeMapFDCB.get(0x66) as OpcodeFunc);
decodeMapFDCB.set(0x68, decodeMapFDCB.get(0x6E) as OpcodeFunc);
decodeMapFDCB.set(0x69, decodeMapFDCB.get(0x6E) as OpcodeFunc);
decodeMapFDCB.set(0x6A, decodeMapFDCB.get(0x6E) as OpcodeFunc);
decodeMapFDCB.set(0x6B, decodeMapFDCB.get(0x6E) as OpcodeFunc);
decodeMapFDCB.set(0x6C, decodeMapFDCB.get(0x6E) as OpcodeFunc);
decodeMapFDCB.set(0x6D, decodeMapFDCB.get(0x6E) as OpcodeFunc);
decodeMapFDCB.set(0x6F, decodeMapFDCB.get(0x6E) as OpcodeFunc);
decodeMapFDCB.set(0x70, decodeMapFDCB.get(0x76) as OpcodeFunc);
decodeMapFDCB.set(0x71, decodeMapFDCB.get(0x76) as OpcodeFunc);
decodeMapFDCB.set(0x72, decodeMapFDCB.get(0x76) as OpcodeFunc);
decodeMapFDCB.set(0x73, decodeMapFDCB.get(0x76) as OpcodeFunc);
decodeMapFDCB.set(0x74, decodeMapFDCB.get(0x76) as OpcodeFunc);
decodeMapFDCB.set(0x75, decodeMapFDCB.get(0x76) as OpcodeFunc);
decodeMapFDCB.set(0x77, decodeMapFDCB.get(0x76) as OpcodeFunc);
decodeMapFDCB.set(0x78, decodeMapFDCB.get(0x7E) as OpcodeFunc);
decodeMapFDCB.set(0x79, decodeMapFDCB.get(0x7E) as OpcodeFunc);
decodeMapFDCB.set(0x7A, decodeMapFDCB.get(0x7E) as OpcodeFunc);
decodeMapFDCB.set(0x7B, decodeMapFDCB.get(0x7E) as OpcodeFunc);
